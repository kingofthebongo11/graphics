...
UNITS_PAIRS = {
    ...
    "Изгибающий момент Ms": MOMENT_UNIT_PAIRS,
    "Изгибающий момент My": MOMENT_UNIT_PAIRS,
    "Изгибающий момент Mt": MOMENT_UNIT_PAIRS,
...
DEFAULT_UNITS = {
    ...
    "Изгибающий момент Ms": "Н·м",
    "Изгибающий момент My": "Н·м",
    "Изгибающий момент Mt": "Н·м",
...
PHYSICAL_QUANTITIES = sort_options(
    [
        ...
        "Изгибающий момент Ms",
        "Изгибающий момент My",
        "Изгибающий момент Mt",
...
PHYSICAL_QUANTITIES_TRANSLATION = {
    ...
    "Изгибающий момент Ms": "Bending moment Ms",
    "Изгибающий момент My": "Bending moment My",
    "Изгибающий момент Mt": "Bending moment Mt",
...
DEFAULT_UNITS_EN = {
    ...
    "Bending moment Ms": "N·m",
    "Bending moment My": "N·m",
    "Bending moment Mt": "N·m",
