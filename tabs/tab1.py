...
def on_combo_changeX_Y_labels(combo, entry, label_size, size_combo):
    ...
    UNITS_MAPPING = {
        ...
        "Сила": ["мН", "Н", "кН"],
        "Продольная сила": ["мН", "Н", "кН"],
        "Поперечная сила": ["мН", "Н", "кН"],
        "Масса": ["г", "кг", "т"],
        "Напряжение": ["Па", "кПа", "МПа"],
        "Интенсивность напряжений": ["Па", "кПа", "МПа"],
        "Напряжение по Мизесу": ["Па", "кПа", "МПа"],
        "Нормальное напряжение X": ["Па", "кПа", "МПа"],
        "Нормальное напряжение Y": ["Па", "кПа", "МПа"],
        "Нормальное напряжение Z": ["Па", "кПа", "МПа"],
        "Касательное напряжение XY": ["Па", "кПа", "МПа"],
        "Касательное напряжение YX": ["Па", "кПа", "МПа"],
        "Касательное напряжение YZ": ["Па", "кПа", "МПа"],
        "Касательное напряжение ZY": ["Па", "кПа", "МПа"],
        "Касательное напряжение ZX": ["Па", "кПа", "МПа"],
        "Касательное напряжение XZ": ["Па", "кПа", "МПа"],
