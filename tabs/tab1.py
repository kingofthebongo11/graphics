...
def on_combo_changeX_Y_labels(combo, entry, label_size, size_combo):
    ...
    UNITS_MAPPING = {
        ...
        "Масса": ["г", "кг", "т"],
        "Напряжение": ["Па", "кПа", "МПа", "кгс/мм²", "кгс/см²", "тс/см²"],
        "Интенсивность напряжений": ["Па", "кПа", "МПа", "кгс/мм²", "кгс/см²", "тс/см²"],
        "Напряжение по Мизесу": ["Па", "кПа", "МПа", "кгс/мм²", "кгс/см²", "тс/см²"],
        "Нормальное напряжение X": ["Па", "кПа", "МПа", "кгс/мм²", "кгс/см²", "тс/см²"],
        "Нормальное напряжение Y": ["Па", "кПа", "МПа", "кгс/мм²", "кгс/см²", "тс/см²"],
        "Нормальное напряжение Z": ["Па", "кПа", "МПа", "кгс/мм²", "кгс/см²", "тс/см²"],
        "Касательное напряжение XY": ["Па", "кПа", "МПа", "кгс/мм²", "кгс/см²", "тс/см²"],
        "Касательное напряжение YX": ["Па", "кПа", "МПа", "кгс/мм²", "кгс/см²", "тс/см²"],
        "Касательное напряжение YZ": ["Па", "кПа", "МПа", "кгс/мм²", "кгс/см²", "тс/см²"],
        "Касательное напряжение ZY": ["Па", "кПа", "МПа", "кгс/мм²", "кгс/см²", "тс/см²"],
        "Касательное напряжение ZX": ["Па", "кПа", "МПа", "кгс/мм²", "кгс/см²", "тс/см²"],
        "Касательное напряжение XZ": ["Па", "кПа", "МПа", "кгс/мм²", "кгс/см²", "тс/см²"],
