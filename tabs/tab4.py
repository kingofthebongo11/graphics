...
def create_tab4(notebook: ttk.Notebook) -> ttk.Frame:
    ...
    def generate_cfile() -> None:
        ...
        analysis_folder_names: dict[tuple[int, int], str] = {}
        for section_index, node in enumerate(roots):
            ...
            for analysis_index, analysis in enumerate(node.children):
                ...
                analysis_folder_names[(section_index, analysis_index)] = numbered_analysis
        ...
        commands = walk_tree_and_build_commands(
            ...
            analysis_folder_names=analysis_folder_names,
        )
